...
func init() {
	...
	//
	DB, err = configureDatastoreDB("assignment-14-238216")
	// [END datastore]
	...
	// bucket name.
	//
	// StorageBucketName = "theeruth"
	StorageBucketName = "pwnimatorz"
	...
	//
	PubsubClient, err = configurePubsub("assignment-14-238216")
	// [END pubsub]
